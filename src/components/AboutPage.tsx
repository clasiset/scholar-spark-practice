...
const AboutPage = ({ goBack, previousPageName }: { goBack?: () => void, previousPageName?: string | null }) => {
  return (
    <div className="bg-gray-50 dark:bg-slate-900 text-gray-800 dark:text-gray-200">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <header className="text-center pt-8 pb-16">
          <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 dark:text-white mb-4 animate-[fade-in_0.5s_ease-out]">About Zehulu.com</h1>
          <p className="max-w-3xl mx-auto text-lg md:text-xl text-gray-600 dark:text-gray-400 animate-[fade-in_0.5s_ease-out_0.2s]">
        ...
        <section className="bg-white dark:bg-slate-800 rounded-xl shadow-lg py-16 px-6 sm:px-8 my-16">
          <div className="max-w-5xl mx-auto">
             <h2 className="text-3xl font-bold mb-12 text-center">Our Guiding Principles</h2>
            <div className="grid md:grid-cols-2 gap-12">
              <div className="flex items-start">
                  <Target className="h-10 w-10 text-blue-600 dark:text-blue-400 mr-4 flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="text-2xl font-semibold">Our Mission</h3>
                    <p className="text-gray-600 dark:text-gray-400 mt-2">To provide high-quality, affordable, and accessible online education that equips individuals with the knowledge and skills necessary to thrive.</p>
                  </div>
              </div>
              <div className="flex items-start">
                  <Eye className="h-10 w-10 text-blue-600 dark:text-blue-400 mr-4 flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="text-2xl font-semibold">Our Vision</h3>
                    <p className="text-gray-600 dark:text-gray-400 mt-2">To be the leading online educational platform in Ethiopia, fostering a community of lifelong learners and innovators who drive positive change.</p>
                  </div>
              </div>
            </div>
            <div className="mt-16">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-1 text-base text-gray-500 dark:text-gray-400">Delivering the highest quality educational content.</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-1 text-base text-gray-500 dark:text-gray-400">Making education available to everyone.</p>
                  </div>
                </div>
                <div className="flex items-start">
                   <div className="flex-shrink-0">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-1 text-base text-gray-500 dark:text-gray-400">Fostering a supportive learning environment.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="py-16">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p className="max-w-2xl mx-auto text-gray-600 dark:text-gray-400 mb-12">The passionate educators and developers dedicated to your success.</p>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              {teamMembers.map((member) => (
                <div key={member.name} className="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-lg text-center transform hover:scale-105 transition-transform duration-300">
