    ...
    <div className="bg-background text-foreground">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <header className="text-center pt-8 pb-16">
          <h1 className="text-4xl md:text-5xl font-extrabold mb-4 animate-[fade-in_0.5s_ease-out]">About Zehulu.com</h1>
        ...
        <section className="bg-card rounded-xl shadow-lg py-16 px-6 sm:px-8 my-16">
          ...
          <div className="max-w-5xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              {teamMembers.map((member) => (
                <div key={member.name} className="bg-card p-6 rounded-lg shadow-lg text-center transform hover:scale-105 transition-transform duration-300">
