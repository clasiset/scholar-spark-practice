  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="container mx-auto px-6">
        ...
        <h1 className="text-4xl font-bold text-center text-gray-800 mb-12">{t.courses.title}</h1>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {courses.map((course) => (
            <div key={course.id} className="bg-white rounded-xl shadow-lg p-6">
              ...
              <p className="text-sm text-gray-500 mb-4">{course.enrolled} {t.courses.studentsEnrolled}</p>
              <button
