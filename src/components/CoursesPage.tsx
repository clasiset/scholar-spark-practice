  ...
  return (
    <div className="min-h-screen bg-background text-foreground py-12">
      <div className="container mx-auto px-6">
        ...
        <h1 className="text-4xl font-bold text-center text-foreground mb-12">Available Courses</h1>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {courses.map((course) => (
            <div key={course.id} className="bg-card rounded-xl shadow-lg p-6">
              <h3 className="text-xl font-bold text-card-foreground mb-4">{course.title}</h3>
              ...
              <button
                ...
                className="w-full bg-primary hover:bg-primary/90 text-primary-foreground font-semibold py-2 px-4 rounded-lg transition duration-300"
              >
                Enroll Now
              </button>
            </div>
