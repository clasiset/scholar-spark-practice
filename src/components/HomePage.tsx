...
const HomePage = ({ navigate, openModal }) => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      {/* Features Section */}
      <section className="py-20 px-6 lg:px-12 bg-background/50 dark:bg-card/50 backdrop-blur-sm">
        <div className="container mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-16">
            Why Choose Our Platform?
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-8 rounded-xl bg-card shadow-lg hover:shadow-xl transition-shadow duration-300">
              <div className="w-16 h-16 bg-secondary/20 rounded-full flex items-center justify-center mx-auto mb-6">
                <svg className="w-8 h-8 text-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <h3 className="text-xl font-semibold mb-4">Comprehensive Practice</h3>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <div key={index} className="bg-card p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
      ...
      <section className="py-20 px-6 lg:px-12 bg-secondary">
        <div className="container mx-auto text-center">
          ...
          {!user && (
            <button
              onClick={() => openModal('signup')}
              className="bg-background hover:bg-background/90 text-secondary font-bold py-4 px-8 rounded-full text-lg shadow-xl transition-all duration-300 ease-in-out transform hover:scale-105"
            >
