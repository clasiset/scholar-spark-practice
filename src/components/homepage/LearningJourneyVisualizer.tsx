      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative mb-20">
          ...
          {journeySteps.map((step, index) => (
            ...
            >
              ...
              <div className="absolute left-1/2 transform -translate-x-1/2 w-16 h-16 bg-white rounded-full shadow-2xl flex items-center justify-center border-4 border-blue-600">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
          {stats.map((stat, index) => (
            <div key={stat.label} className="bg-white rounded-2xl p-8 shadow-xl">
