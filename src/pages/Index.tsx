...
const Index = () => {
  ...
  const renderContent = () => {
    switch (currentPage) {
      ...
      case 'subjectExams':
        return <SubjectExamsPage subjectTitle={pageData?.subjectTitle} examType={pageData?.examType} navigate={navigate} goBack={goBack} previousPageName={previousPageName} openModal={openModal} />;
      case 'examPage':
